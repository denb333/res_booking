        ...
        <div class="row mb-5">
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li><a href="#" class="py-2 d-block">Restaurant in Da Nang City</a></li>
                <li><a href="#" class="py-2 d-block">+84 388517042</a></li>
                <li><a href="#" class="py-2 d-block">lhnam2109@gmail.com</a></li>
                <li><a href="#" class="py-2 d-block">hungnv.21it@vku.udn.vn</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
